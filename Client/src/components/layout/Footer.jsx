    ...
    <footer className="bg-white border-t border-slate-200 w-full overflow-hidden mt-auto relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-6 lg:pt-16 lg:pb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 gap-10 lg:gap-8">
          ...
          {/* 🏢 BRAND COLUMN */}
          <div className="flex flex-col items-start space-y-5 sm:col-span-2 md:col-span-7 lg:col-span-5">
            ...
            <div className="flex items-center gap-3 pt-2">
              {[
                ...
                <a
                  ...
                  className={`flex items-center justify-center w-10 h-10 rounded-xl border shadow-sm hover:-translate-y-1 hover:shadow-md transition-all duration-300 will-change-transform ${social.colorStyle}`}
                >
                  <social.icon size={16} />
                </a>
              ))}
          ...
          {/* 🔗 QUICK LINKS */}
          <div className="sm:col-span-1 md:col-span-5 lg:col-span-3 lg:col-start-7 flex flex-col items-start">
            <h4 className="font-serif font-black text-black text-lg mb-4 tracking-tight">
              Quick Links
            </h4>
            <ul className="flex flex-row flex-wrap md:flex-col gap-x-6 gap-y-3 md:gap-y-2 md:gap-x-0 items-center md:items-start">
              {[
                { name: "Home", href: "/" },
                ...
                <li key={link.name}>
                  ...
                  >
                    <span className="relative flex flex-col items-start gap-0.5">
                      ...
                      <span className="block h-[2px] w-full bg-indigo-600 scale-x-0 origin-left transition-transform duration-500 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] group-hover:scale-x-100" />
                    </span>
                  </Link>
                </li>
              ))}
          ...
          {/* 📍 CONTACT INFO */}
          <div className="sm:col-span-1 md:col-span-12 lg:col-span-3 flex flex-col items-start">
            <h4 className="font-serif font-black text-black text-lg mb-4 tracking-tight">
              Get in Touch
            </h4>
            <div className="w-full flex flex-row flex-wrap lg:flex-col gap-x-6 gap-y-5 lg:gap-y-6 lg:gap-x-0 items-start">
              <div className="flex flex-row items-start gap-4 group cursor-pointer">
                <div className="w-8 h-8 rounded-lg bg-amber-50 border border-amber-100 flex items-center justify-center text-amber-500 group-hover:border-amber-500 group-hover:text-white group-hover:bg-amber-500 transition-colors duration-300 shrink-0 shadow-sm mt-0.5">
              ...
              <div className="flex flex-row items-start gap-4 group cursor-pointer">
                <div className="w-8 h-8 rounded-lg bg-emerald-50 border border-emerald-100 flex items-center justify-center text-emerald-500 group-hover:border-emerald-500 group-hover:text-white group-hover:bg-emerald-500 transition-colors duration-300 shrink-0 shadow-sm mt-0.5">
                  <FaPhoneAlt size={12} />
                </div>
                <div className="flex flex-col items-start text-left">
              ...
              <div className="flex flex-row items-start gap-4 group cursor-pointer">
                <div className="w-8 h-8 rounded-lg bg-blue-50 border border-blue-100 flex items-center justify-center text-blue-500 group-hover:border-blue-500 group-hover:text-white group-hover:bg-blue-500 transition-colors duration-300 shrink-0 shadow-sm mt-0.5">
                  <FaEnvelope size={14} />
                </div>
                <div className="flex flex-col items-start text-left">
