            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center justify-between h-20">
                    ...
                    <button
                        ...
                        className="flex md:hidden items-center justify-center w-10 h-10 border-[1.5px] border-slate-300 text-slate-600 hover:text-black hover:border-slate-400 bg-white transition-colors duration-150"
                    >
